    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="">WecivStore</a>
                <a class="btn btn-link" href="">WeCIVEvent</a>
                <a class="btn btn-link" href="">CIMS</a>
                <a class="btn btn-link" href="">ADAN</a>
            </div>
            <div class="col-lg-3 col-md-6">
                <h5 class="text-light mb-4">Quick Links</h5>
                <a class="btn btn-link" href="">Accueil</a>
                <a class="btn btn-link" href="">Services</a>
                <a class="btn btn-link" href="">Carrière</a>
                <a class="btn btn-link" href="">Contacte</a>
